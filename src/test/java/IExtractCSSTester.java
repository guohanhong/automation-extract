...
public class IExtractCSSTester {
	...
	public static void main(String[] args) throws ClientProtocolException, IOException, XPathExpressionException,
		...
		HttpGet get = new HttpGet("https://item.jd.com/10040295551.html");
		...
		if (entity != null) {
			...
			String outResult = IExtract
					.extract(html, Constant.EXTRACT_MODE_CSS, "div > div.itemInfo-wrap > div.sku-name").toString();
